          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{route('groups.index')}}" class="menu-link">
                ...
                <div data-i18n="Tables">groups</div>
              </a>
            </li>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('students.index')}}" class="menu-link">
                    <div data-i18n="Account">all students</div>
                  </a>
                </li>
                @can('create_quiz')
                  
                <li class="menu-item">
                  <a href="{{route('exams_and_quizzes')}}" class="menu-link">
                    <div data-i18n="Notifications"> add exams & quizzes</div>
                  </a>
                </li>
                @endcan
                @can('view_quizzes')
                ...
                <li class="menu-item">
                  <a href="{{route('quizzes.index')}}" class="menu-link">
                    <div data-i18n="Connections">quizzes</div>
                  </a>
                </li>
                @endcan
                @can('view_exams') 
                ...
                <li class="menu-item">
                  <a href="{{route('exams.index')}}" class="menu-link">
                    <div data-i18n="Connections">exams</div>
                  </a>
                </li>
                @endcan
                @can('update_student') 
                ...
                <li class="menu-item">
                  <a href="{{route('view_mark_form')}}" class="menu-link">
                    <div data-i18n="Connections">add mark</div>
                  </a>
                </li>
                @endcan
              </ul>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">   @isset(Auth::user()->name )
                              {{ Auth::user()->name }}
