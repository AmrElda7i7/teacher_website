  ...
  <!-- / Menu -->
    <div class="card">
      ...
      <div class="d-flex justify-content-center">
        <a  href="{{route('roles.create')}}" type="button" class="btn rounded-pill btn-outline-primary" style="width: 250px;">add role</a>
      </div>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    >
                    <a class="dropdown-item" href="{{url('roles/delete/'.$role->id)}}"
