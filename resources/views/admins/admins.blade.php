  ...
  <!-- / Menu -->
    <div class="card">
      ...
      <div class="d-flex justify-content-center">
        <a  href="{{route('admins.create')}}" type="button" class="btn rounded-pill btn-outline-primary" style="width: 250px;">add admin</a>
      </div>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    >
                    <a class="dropdown-item" href="{{url('admins/delete/'.$user->id)}}"
