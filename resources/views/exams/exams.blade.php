          ...
          <table class="table">
            ...
            <tbody class="table-border-bottom-0">
              ...
              <tr class="table-success">
                ...
                <td>
                  <i class="fab fa-bootstrap fa-lg text-primary me-3"></i> <strong>{{$exam->id}}</strong>
                </td>
                <td>
                  <i class="fab fa-bootstrap fa-lg text-primary me-3"></i> <strong>{{$exam->exam_name}}</strong>
                </td>
                <td>
                  <i class="fab fa-bootstrap fa-lg text-primary me-3"></i> <strong>{{$exam->mark}}</strong>
                </td>
