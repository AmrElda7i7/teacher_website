...
>
  ...
  <!-- / Menu -->
    ...
    <div class="card">
      <form action="{{route('find_student')}}" method="post">
@csrf
        <h5 class="card-header">roles page</h5>
      ...
      <div class="d-flex justify-content-center">
        ...
        <a  href="{{route('students.create')}}" type="button" class="btn rounded-pill btn-outline-primary" style="width: 250px;">add student</a>
    </div>
    @endcan
              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    >
                    <a class="dropdown-item" href="{{url('students/delete/'.$student->id)}}"
                      ><i class="bx bx-trash me-2"></i> Delete</a
                      >
                    <a class="dropdown-item" href="{{route('attend',$student->id)}}"
                      ><i class="bx bx-edit me-2"></i> attends</a
                      >
                ...
                <td>
                  <a href="{{route('students.show',$student->id)}}" class="link-success">details</a>
                </td>
                @endcan
            </tr>
            @endforeach
