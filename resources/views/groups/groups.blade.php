  ...
  <!-- / Menu -->
    <div class="card">
      ...
      <div class="d-flex justify-content-center">
          <a  href="{{route('groups.create')}}" type="button" class="btn rounded-pill btn-outline-primary" style="width: 250px;">add group</a>
        </div>
        @endcan
            ...
            <tr>
              ...
              <td>
                  ...
                  <div class="dropdown">
                    ...
                    >
                    <a class="dropdown-item" href="{{url('groups/delete/'.$group->id)}}"
